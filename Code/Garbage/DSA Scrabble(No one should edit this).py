...
for x in range (15):
    for y in range(15):
        if (x,y) == (7,7):
            ...
            but = Button(root, text = 'X',height = 2, width = 5, borderwidth = 5, bg = 'yellow',fg='black')
...
##Score Board:
scoreframe = LabelFrame(root, text = 'Score Board:')
scoreframe.grid(row = 0, column = 15,rowspan = 3,columnspan = 3, sticky = W+E, padx = 10)
...
direcframe = LabelFrame(root, text = 'Select Your Prefered Direction:')
direcframe.grid(row = 4,column = 15, rowspan = 2, columnspan = 3, padx = 10, sticky = W+E)
...
def quit_func():
    ...
    if quit_box == 1:
        root.quit()
    return
quit_but = Button(root, text = 'Quit Game', height = 2, width = 30, borderwidth = 5, bg = 'black',fg='white', command = quit_func)
quit_but.grid(row=14, column = 15, padx = 10, sticky = W+E)
...
shuff_but = Button(root, text = 'Shuffle Tray', height = 2, width = 30, borderwidth = 5, command = shuff_func)
shuff_but.grid(row=13, column = 15, padx = 10, sticky = W+E)


##Skip Turn Button and func:
skip_but = Button(root, text = 'Skip Turn' , height = 2, width = 15, borderwidth = 5, bg = 'black',fg='white')
skip_but.grid(row=12, column = 15, padx = 10,sticky = E)

##Text box for word:
word = Entry(root,width=8, font = ('DJB Letter Game Tiles',20))
word.insert(0, 'Word Here')
word.grid(row = 6, column = 15,columnspan = 10, sticky = W+E, padx = 10)

##Player Tile:
tile_frame = LabelFrame(root, text = 'Player Tiles:')
tile_frame.grid(row= 7, column = 15, padx=10,rowspan = 3, columnspan =3, sticky = W+E)
tiles = {}
for x in range (7):
    if x <=4:
...
##Player Turn:
name_frame = LabelFrame(root, text = 'Player To Turn')
name_frame.grid(row = 3,column = 15, columnspan = 3, padx = 10, sticky = W+E)
...
detail_frame = LabelFrame(root, text = 'Details of Submission:',pady = 10)
detail_frame.grid(row =9, column = 15, padx = 10, rowspan = 3, columnspan = 3, sticky = W+E)
...
##Submit Button:
submit_but = Button(root, text = 'Submit Data', height = 2, width = 15, borderwidth = 5, bg = 'black',fg='white', command = change_turn)
submit_but.grid(row=12, column = 15, padx = 10,sticky = W)      
