...
list_of_scores = [('A', 1), ('E', 1), ('I', 1), ('O', 1), ('U', 1), ('L', 1), ('N', 1), ('S', 1), 
('T', 1), ('R', 1), ('D', 2), ('G', 2), ('B', 3), ('C', 3), ('M', 3), ('P', 3), ('F', 4), 
('H', 4), ('V', 4), ('W', 4), ('Y', 4), ('K', 5), ('J', 8), ('X', 8), ('Q', 10), ('Z', 10), ('#', 0)]
board = Tk()
POC = IntVar()
counter = 1
TNOT = 0
...
Player1 = Label(scoreframe, text = pname[1]+':')
Player1.grid(row = 0, column = 0)

if len(pname) == 3:
    Player2 = Label(scoreframe, text = pname[2]+':')
...
if len(pname) == 4:
    ...
    Player3 = Label(scoreframe, text = pname[3]+':')
...
if len(pname) == 5:
    ...
    Player4 = Label(scoreframe, text = pname[4]+':')
...
name_dispaly = Label(name_frame, text = pname[counter]+'; It\'s your turn')
...
def Submitfunc():
    global words,TNOT, POC, skip, nop, counter, crossflag, racktemp
    wordtemp = []
    racktemp = []
...
def change_turn(skipt, nop):
    global counter, TNOT, skip, racktemp, pname
    if counter == skipt:
        skip = 0
        if counter == nop:
            counter = 0
        counter = counter + 1
        name_dispaly.config(text = pname[counter]+'; It\'s your turn')
